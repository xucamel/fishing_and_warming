...
for (t in 2:N_1){
P_med_1[t]=P_PT(P_med_1[t-1],r_1,k_1,2,F_1[t-1],Environment_1[t-1],impact_E_1);
...
generated quantities {
  ...
  surplus_production[1] = SP_PT(P_initial_1,r_1,k_1,2,Environment_1[1],impact_E_1);
  for (t in 2:N_1){
    ...
    P_no_fishing[t] = P_PT_stocking(P_med_1[t-1],r_1,k_1,2,0, Environment_1[t-1],impact_E_1,Stocking_1[t-1]);
    P_no_fishing_adjusted[t] = P_PT_stocking(P_med_1[t-1],r_1,k_1,2,0, Environment_1[t-1],impact_E_1*1.98,Stocking_1[t-1]);
    P_no_env[t] = P_PT(P_med_1[t-1],r_1,k_1,2,F_1[t-1], Environment_1[t-1],0);
    P_one_env[t] = P_PT(P_med_1[t-1],r_1,k_1,2,F_1[t-1], Environment_1[1],impact_E_1);
    surplus_production[t] = SP_PT(P_initial_1,r_1,k_1,2,Environment_1[t],impact_E_1);
  }
